...
if __name__ == "__main__":
    ...
    chairman: _CouncilMetadata = _CouncilMetadata.from_file("chairman", id='bureaucrat-chairman' )
    council: _CouncilMetadata = _CouncilMetadata.from_file("council", id='ai-council' ) 
